...
class Notificacion {
  ...
  Notificacion({this.transaction_id, this.day, this.hour, this.acct_no, this.extracted_amount, this.comission_amount, this.create_date, this.tipo, this.exp_date, this.description, this.image});

  factory Notificacion.fomJson(Map<String, dynamic> json) {
