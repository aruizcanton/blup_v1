...
class DetalleSaldo extends StatelessWidget {
  final SaldoActual saldoActual;
  ...
  DetalleSaldo(this.saldoActual, this.origenDeLaLLamada);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: saldoActual.detalle.length > 0
      ? Container (
